#ifndef __MYOS_HARDWAERCOMMUNICATION__PORT_H
#define __MYOS_HARDWAERCOMMUNICATION__PORT_H
...
class Port8Bit : public Port {
   ...
   protected:
    ...
    static inline void Write8(myos::common::uint16_t _port,
                              myos::common::uint8_t _data) {
...
class Port8BitSlow : public Port8Bit {
   ...
   protected:
    static inline void Write8Slow(myos::common::uint16_t _port,
                                  myos::common::uint8_t _data) {
...
class Port16Bit : public Port {
   ...
   protected:
    ...
    static inline void Write16(myos::common::uint16_t _port,
                               myos::common::uint16_t _data) {
...
class Port32Bit : public Port {
   ...
   protected:
    ...
    static inline void Write32(myos::common::uint16_t _port,
                               myos::common::uint32_t _data) {
